...
1. **Access FileVault**
   Click "Get Started" on the landing page to open the app.

2. **Upload Files**
   Click the "Upload Files" button or drag files into the drop zone.
   Upload progress is shown via a progress bar.
...
Licensed under the MIT License. See the [LICENCE](LICENSE) file for details.
